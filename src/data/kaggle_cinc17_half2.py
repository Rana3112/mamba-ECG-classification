"""
============================================================================
 KAGGLE NOTEBOOK — PhysioNet CINC 2017 Training (HALF 2 of 2)
============================================================================
 Target GPU : NVIDIA P100 (16 GB VRAM)
 Dataset    : PhysioNet/CinC 2017 Challenge — SECOND HALF (records 4264-8527)
...
HALF = 2  # This script trains on HALF 2 (second 50% of records)
